/* Get schoarships data from kaggle */
...
The  data  has five string  columns and one interger column*/
...
/*Fetch entries that  atleast  have a batchelor*/
...
1.
2. Fectch locations those having more than 100 people */
